    ...
    return (
        <div>
            <div className="relative grid grid-cols-10">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg bg-white w-[29rem] h-[45rem] rounded-lg py-8">
                    <div className="text-center">
                        ...
                        <form className='w-10/12 mx-auto space-y-6 mt-10'>
                            ...
                            <div>
                                ...
                                <input className='w-full mt-2 py-3 border px-4 rounded-lg font-light text-sm' type="text" name="name" placeholder="name... " id="" />
                            </div>
                            {/* Email */}
                            <div>
                                <label className="block font-bold text-left ml-4 text-sm" htmlFor="email">E-Mail Address</label>
                                <input className='w-full mt-2 py-3 border px-4 rounded-lg font-light text-sm' type="text" name="email" placeholder="email... " id="" />
                            </div>
                            {/* Password */}
                            <div>
                                <label className='block text-left font-bold text-sm ml-4' htmlFor="password">Password</label>
                                <input className='w-full mt-2 py-3 border px-4 rounded-lg font-light text-sm' type="password" name="Password" placeholder="password " id="" />
                            </div>
                            {/* Photo URL */}
                            <div>
                                <label className='block text-left font-bold text-sm ml-4' htmlFor="photo">Photo URL</label>
                                <input className='w-full mt-2 py-3 border px-4 rounded-lg font-light text-sm' type="text" name="photo" placeholder="photo URL " id="" />
                            </div>
