...
const MyToysItem = (props) => {
    ...
    return (
        <tr className="border-4 border-black">
            ...
            <td className="border px-4"><div className="flex items-center space-x-1 border-2 py-1 px-2 border-black btn-animation"><FaTrash /><button onClick={() => handleDeleteClick(_id)}>Delete</button></div></td>
        </tr>
    );
};
